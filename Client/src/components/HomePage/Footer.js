    ...
    return (
        <footer className="bg-white py-4">
            <div className="text-center">
                ...
                <span className="block text-sm text-center text-blue-600">
                    © 2024-2025 QuickTour™. All Rights Reserved. 
                </span>
                ...
                <ul className="flex justify-center mt-3 space-x-5">
                    ...
                    <li>
                        <a href="#" className="text-blue-600 hover:text-gray-900">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 ```javascript
0 24 24" aria-hidden="true">
                    ...
                    <li>
                        <a href="#" className="text-blue-600 hover:text-gray-900">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm6.605 4.61a8.502 8.502 0 011.93 5.314c-.281-.054-3.101-.629-5.943-.271 ```javascript
